...
// } else if(num < 0){
//     console.log("Nujmber is Negative");
// } else {
...
// // 🔁 Part 2: For Loop, While Loop with Conditions (10
// // Questions)
...
// // Qs. 3. Write a program that prints the multiplication table of a number (e.g., 7) using a for
// // loop.
// let num = 7;
// let i = 1;
// while(i <= 10){
...
// // Qs. 5. Create a program to count how many numbers between 1 and 100 are divisible by both
